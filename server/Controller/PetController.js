...
const deletePost = async (req, res) => {
  ...
  const mailOptions = {
      from: process.env.EMAIL_USER,
      to: pet.email,
      subject: 'Pet Submission Removed - Paw-Fect Match',
      text: `Dear ${pet.name},\n\nWe wanted to inform you that your pet submission has been removed from the Paw-Fect Match platform by our admin team.\n\nIf you have any questions or would like to understand more about this decision, please feel free to reach out to us.\n\nWe appreciate your understanding.\n\nBest regards,\nThe Paw-Fect Match Team`
  };
