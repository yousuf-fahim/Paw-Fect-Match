...
const CardBelowHome = () => {
  ...
  return (
    <div className='dark-grey-container'>
      ...
      <div className='right-para'><p className='we-do'>WHAT WE DO?</p>With a focus on matching the right pet with the right family, Paw-Fect Match makes it easy to adopt love and foster happiness.</div>
    </div>
  )
}
